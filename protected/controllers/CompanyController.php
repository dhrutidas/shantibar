...
class CompanyController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('MCompany');
	...
	{
		$model=new MCompany('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MCompany']))
			$model->attributes=$_GET['MCompany'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mcompany-form')
		{
