...
class ProductController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('MProduct');
	...
	{
		$model=new MProduct('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MProduct']))
			$model->attributes=$_GET['MProduct'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mproduct-form')
		{
