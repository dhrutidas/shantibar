...
class StockController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('MStock');
	...
	{
		$model=new MStock('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MStock']))
			$model->attributes=$_GET['MStock'];
	...
	{
		$model=MStock::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mstock-form')
		{
